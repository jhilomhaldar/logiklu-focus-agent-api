...
def build_focus_company_intelligence_response(row: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "account": {
            ...
            "location": {
                "country": first_non_empty(row.get("lead_country"), row.get("country")),
                "state": first_non_empty(row.get("lead_state"), row.get("state")),
                "city": first_non_empty(row.get("lead_city"), row.get("city")),
            },
