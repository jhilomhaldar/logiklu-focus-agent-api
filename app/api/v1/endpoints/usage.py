...
def api_usage_page():
  ...
  -H "X-API-KEY: YOUR_API_KEY"</pre>
            ...
            <div class="card">
                ...
                <p>Fetches account/company records from LogiKlu CRM.</p>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>General search across account name, website, email, phone, industry, city, state, country, and lead source.</td>
                        </tr>
                        <tr>
                            <td><code>lead_publish_status</code></td>
                            <td><code>active</code></td>
                            <td>Allowed values: <code>active</code>, <code>archive</code>, <code>all</code>.</td>
                        </tr>
                        <tr>
                            <td><code>computed_lead_category</code></td>
                            <td><code>lead</code></td>
                            <td>Allowed values: <code>all</code>, <code>lead</code>, <code>potential_lead</code>, <code>customer</code>.</td>
                        </tr>
                        <tr>
                            <td><code>filters</code></td>
                            <td><code>[{"field":"country","operator":"eq","value":"Japan"}]</code></td>
                            <td>Dynamic field-specific search conditions.</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <p>Default active accounts:</p>
                <pre>curl -X GET "https://api.logiklu.com/api/v1/accounts?limit=20&offset=0" \\
  -H "X-API-KEY: YOUR_API_KEY"</pre>
  ...
  -H "X-API-KEY: YOUR_API_KEY"</pre>
                ...
                <pre>curl -X GET "https://api.logiklu.com/api/v1/accounts?search=Hamamatsu&limit=20&offset=0" \\
  -H "X-API-KEY: YOUR_API_KEY"</pre>

                <p>Search only by account name using filters:</p>
                <pre>curl -X GET 'https://api.logiklu.com/api/v1/accounts?filters=[{"field":"lead_name","operator":"like","value":"Hamamatsu"}]' \\
  -H "X-API-KEY: YOUR_API_KEY"</pre>
            </div>
